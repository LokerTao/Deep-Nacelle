...
DNN_flowfield = torch.load("") # Load the best model from ../../Predict_Flowfield/DNN/
DNN_cd = torch.load("") # Load the best model from ../../Predict_Cd/DNN/
...
def func(x):
    ...
    with torch.no_grad():
        ...
        y = DNN_cd(DNN_flowfield(x),x)*0.205
